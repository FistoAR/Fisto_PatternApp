...
const mockupGlbs = popupGlbs.map(str => str.replace('../../assets', '../assets'));

fs.writeFileSync('popup_glbs_fixed.txt', popupGlbs.join('\n'));
fs.writeFileSync('mockup_glbs_fixed.txt', mockupGlbs.join('\n'));
