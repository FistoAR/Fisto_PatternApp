...
export default function AnimatedSvgCard({ src, index = 0 }) {
  ...
  return (
    <div ref={wrapperRef} className="relative group category-wrapper w-full flex-1 justify-center cursor-pointer will-change-transform">
      ...
      />
      <div className="absolute -bottom-14 left-1/2 -translate-x-1/2 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.08)] border border-gray-100 text-gray-700 transition-colors duration-300 group-hover:bg-[#C15F27] group-hover:text-white group-hover:border-[#C15F27] z-10 pointer-events-none">
