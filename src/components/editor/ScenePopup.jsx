...
export default function ScenePopup({
  ...
  return (
    <div className="w-[280px] sm:w-[350px] h-full shrink-0 bg-white rounded-[15px] shadow-[0_8px_32px_rgba(0,0,0,0.14)] ring-1 ring-gray-100 overflow-hidden flex flex-col">
