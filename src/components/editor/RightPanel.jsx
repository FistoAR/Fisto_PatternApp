            ...
            {isSwappingModel && (
              <div style={{
                ...
                <div style={{
                  ...
                  height: '32px',
                  borderRadius: '50%',
                  border: '3px solid rgba(192, 98, 58, 0.2)',
                ...
                `}</style>
                <span style={{ marginTop: 8, fontSize: '11px', fontWeight: 700, color: '#c0623a' }}>Loading Model...</span>
              </div>
            )}
            <R3FCanvas
...
function AutoSizedModel({
  ...
  useEffect(() => {
    ...
    clonedScene.traverse((obj) => {
      ...
      const shouldApply = hasLabelMesh ? labelMeshUuids.has(obj.uuid) : true;
