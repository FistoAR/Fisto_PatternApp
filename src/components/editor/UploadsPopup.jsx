...
export default function UploadsPopup({
  ...
  const processFile = useCallback((file) => {
    ...
    onUpload(file, url, undefined, selectedTypeRef.current);
  }, [onUpload]);
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-xs font-bold text-[#c05520] m-0">Tape Layout Editor</p>
                  <p className="text-[10px] text-gray-500 m-0">Create repeat patterns for tape</p>
                </div>
              </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                strokeWidth={2.5}
                stroke="currentColor"
                className="w-4 h-4 text-[#c05520] transition-transform duration-300 group-hover:translate-x-1"
              >
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
          ...
          {mainTab === 'default' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              {defaultAssets[defaultTab].length > visibleCount && (
                <button
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = '#c0623a'; e.currentTarget.style.color = '#c0623a'; }}
