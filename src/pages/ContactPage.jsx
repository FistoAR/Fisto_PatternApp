      ...
      <main className="flex-1 w-full pt-16 lg:pt-24 px-6 lg:px-12 xl:px-20 bg-[#FBF9F6]">
        <div className="max-w-[1200px] mx-auto w-full flex flex-col">
          ...
          <div className="mb-12 px-4 text-left">
            ...
            <p className="text-gray-600 text-lg leading-relaxed font-medium  max-w-2xl">
          ...
          {/* Content Section */}
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 mb-24 bg-[#FBF9F6] px-4">
            ...
            <div className="flex flex-col gap-8 w-full lg:w-1/3">
              ...
              {/* Map Image */}
              <div className="w-full rounded-3xl overflow-hidden shadow-md border border-[#f5e9df] lg:flex-1 lg:min-h-[250px] flex">
            ...
            {/* Right Column - Form */}
            <div className="w-full lg:w-2/3 max-w-2xl mt-[3vw]  rounded-3xl p-8 lg:p-10 shadow-[0_12px_40px_rgba(0,0,0,0.04)] border border-gray-50 bg-white">
